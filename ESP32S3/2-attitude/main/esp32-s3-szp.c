...
static const char *TAG = "esp32-s3-szp";
...
{
    return i2c_master_write_read_device(I2C_MASTER_NUM, QMI8658_SENSOR_ADDR, &reg_addr, 1, data, len, I2C_MASTER_TIMEOUT_MS / portTICK_PERIOD_MS);
}
...
static esp_err_t qmi8658_register_write_byte(uint8_t reg_addr, uint8_t data)
{
    ...
    return i2c_master_write_to_device(I2C_MASTER_NUM, QMI8658_SENSOR_ADDR, write_buf, sizeof(write_buf), I2C_MASTER_TIMEOUT_MS / portTICK_PERIOD_MS);
